...
Copyright (C) 2016 Ferdinand Tavernini WOBI-IPES Bozen/Bolzano

The XSL-stylesheet fatturapa_v1.2_de-it.xsl is free software:
you can redistribute it and/or modify it under the terms of the
GNU General Public License as published by the Free Software
Foundation, either version 3 of the License, or any later version.

fatturapa_v1.2_de-it.xsl is distributed in the hope that it will
...
<xsl:stylesheet version="1.2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:a="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2">
     ...
     <xsl:variable name="VersionFT">
         <p>Stylesheet fatturapa_v1.2_de-it_wd.xsl v20170307 Ferdinand Tavernini - <a href="http://tinyurl.com/fatturapa-xsl-southtyrol">http://tinyurl.com/fatturapa-xsl-southtyrol</a></p>
     </xsl:variable>
...
body { max-width: 1010px; min-width: 990px; }
                                                                 ...
                                                                 <xsl:if test="IdTrasmittente or ProgressivoInvio or FormatoTrasmissione">
                                                                      <tr><td width="70px">1.1.[3|1|2]</td>
                                                                           ...
                                                                           <xsl:if test="CodiceDestinatario">
                                                                                <tr><td>1.1.4</td><td>Kodex Rechnungsempfänger<br /><i>Codice destinatario</i></td>
                                                                 ...
                                                                 <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/DatiAnagrafici">
                                                                      <xsl:if test="Anagrafica/Denominazione or Anagrafica/Nome">
                                                                           <tr><td width="70px">1.2.1.3.[1|4|2|3]</td><td width="170px">Benennung<br /><i>Nominativo</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Anagrafica/Denominazione" />&#160;<xsl:value-of select="Anagrafica/Titolo" />&#160;<xsl:value-of select="Anagrafica/Nome" />&#160;<xsl:value-of select="Anagrafica/Cognome" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 ...
                                                                 <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/Sede">
                                                                      <xsl:if test="Indirizzo or NumeroCivico or CAP or Comune or Provincia or Nazione">
                                                                           <tr><td width="70px">1.2.2.[1|2|3|4|5|6]</td><td width="170px">Anschrift<br /><i>indirizzo</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Indirizzo" />&#160;<xsl:value-of select="NumeroCivico" /><br /><xsl:value-of select="CAP" />&#160;<xsl:value-of select="Comune" />&#160;<xsl:value-of select="Provincia" />&#160;<xsl:value-of select="Nazione" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </xsl:for-each>
                                                            </table>
                                                                 ...
                                                                 <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/IscrizioneREA">
                                                                      <xsl:if test="Ufficio">
                                                                           <tr><td width="70px">1.2.4.1</td><td width="170px">Handelsregister der Provinz<br /><i>Uff. Reg. Imp. Provinciale</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Ufficio" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="Telefono">
                                                                           <tr><td width="70px">1.2.5.1</td><td width="170px">Telefon<br /><i>Telefono</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Telefono" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                      <xsl:if test="Fax">
                                                                           <tr><td width="70px">1.2.5.2</td><td width="170px">FAX<br /><i>Fax</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Fax" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                      <xsl:if test="Email">
                                                                           <tr><td width="70px">1.2.5.3</td><td width="170px">E-Mail<br /><i>E-mail</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Email" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </table>
                                                            </xsl:if>
                                                       ...
                                                       <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/StabileOrganizzazione">
                                                            ...
                                                            <table id="t1">
                                                                 <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/StabileOrganizzazione">
                                                                      <xsl:if test="Indirizzo or NumeroCivico or CAP or Comune or Provincia or Nazione">
                                                                           <tr><td width="70px">1.4.3.[1|2|3|4|5|6]</td><td width="170px">Anschrift<br /><i>indirizzo</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Indirizzo" />&#160;<xsl:value-of select="NumeroCivico" /><br /> <xsl:value-of select="CAP" />&#160;<xsl:value-of select="Comune" />&#160;<xsl:value-of select="Provincia" /> &#160;<xsl:value-of select="Nazione" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </xsl:for-each>
                                                            ...
                                                            <table id="t1">
                                                                 <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/RappresentanteFiscale">
                                                                      ...
                                                                      <xsl:if test="Denominazione or Nome or Cognome">
                                                                           <tr><td width="70px">1.4.4.[2 / 3|4]</td><td width="170px">Benennung<br /><i>denominazione</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Denominazione" />&#160;<xsl:value-of select="Nome" />&#160;<xsl:value-of select="Cognome" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </xsl:for-each>
                                                            </table>
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="DatiAnagrafici/Anagrafica/Denominazione or DatiAnagrafici/Anagrafica/Titolo or DatiAnagrafici/Anagrafica/Nome or DatiAnagrafici/Anagrafica/Cognome">
                                                                           <tr><td width="70px">1.5.1.3.[1|4|2|3]</td><td width="170px">Anschrift<br /><i>indirizzo</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="DatiAnagrafici/Anagrafica/Denominazione" />&#160;<xsl:value-of select="DatiAnagrafici/Anagrafica/Titolo" />&#160;<xsl:value-of select="DatiAnagrafici/Anagrafica/Nome" /> &#160;<xsl:value-of select="DatiAnagrafici/Anagrafica/Cognome" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                             ...
                                             <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/SoggettoEmittente">
                                                  <div id="soggetto-emittente">
                                                       ...
                                                       <table id="t1">
                                                            ...
                                                            <td width="731px"><span><xsl:value-of select="a:FatturaElettronica/FatturaElettronicaHeader/SoggettoEmittente" /> </span><xsl:variable name="SC"><xsl:value-of select="a:FatturaElettronica/FatturaElettronicaHeader/SoggettoEmittente" /> </xsl:variable>
                                                                 <xsl:choose>
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="DatiGenerali/DatiGeneraliDocumento/TipoDocumento">
                                                                           <tr><td width="70px">2.1.1.[2|1]</td><td width="170px">Währung : Dokumententyp<br /><i>Valuta : Tipologia doc.</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="$Valuta" />&#160;:&#160;<xsl:value-of select="DatiGenerali/DatiGeneraliDocumento/TipoDocumento" /> </span><xsl:variable name="TD"><xsl:value-of select="DatiGenerali/DatiGeneraliDocumento/TipoDocumento" /> </xsl:variable>
                                                                                          <xsl:choose>
                                                                                ...
                                                                                <table id="t1">
                                                                                     <xsl:if test="TipoRitenuta">
                                                                                          <tr><td width="70px">2.1.1.5.1</td><td width="170px">Art des Einbehaltes<br /><i>Tipologia ritenuta</i></td>
                                                                                               <td width="731px"><span><xsl:value-of select="TipoRitenuta" /></span><xsl:variable name="TR"><xsl:value-of select="TipoRitenuta" /></xsl:variable>
                                                                                               <xsl:choose>
                                                                                ...
                                                                                <table id="t1">
                                                                                     <xsl:if test="BolloVirtuale">
                                                                                          <tr><td width="70px">2.1.1.6.1</td><td width="170px">Virtueller Stempelwert<br /><i>Bollo virtuale</i></td>
                                                                                               <td width="731px"><span><xsl:value-of select="BolloVirtuale" /></span></td>
                                                                                          </tr>
                                                                                     </xsl:if>
                                                                                ...
                                                                                <table id="t1">
                                                                                     <xsl:if test="TipoCassa">
                                                                                          <tr><td width="70px">2.1.1.7.1</td><td width="170px">Fürsorgekasse<br /><i>Cassa previdenziale</i></td>
                                                                                               <td width="731px"><span><xsl:value-of select="TipoCassa" /></span><xsl:variable name="TC"><xsl:value-of select="TipoCassa" />
                                                                                               </xsl:variable>
                                                                                               <xsl:choose>
                                                                 ...
                                                                 <xsl:for-each select="DatiGenerali/DatiOrdineAcquisto">
                                                                           <xsl:if test="RiferimentoNumeroLinea">
                                                                                <tr><td width="70px">2.1.2.1</td><td width="170px">Zugehörige Zeilennummer der Rechnung<br /><i>Numero linea di fattura a cui si riferisce</i></td>
                                                                                     <td width="731px"><xsl:for-each select="RiferimentoNumeroLinea"><span><xsl:if test="(position( )) > 1">, </xsl:if><xsl:value-of select="." /></span></xsl:for-each></td>
                                                                                </tr>
                                                                           </xsl:if>
                                                                           <xsl:if test="IdDocumento">
                                                                                <tr><td width="70px">2.1.2.2</td><td width="170px">Bestellkennung<br /><i>Ident. ordine di acquisto</i></td>
                                                                                     <td width="731px"><span><xsl:value-of select="IdDocumento" /></span></td>
                                                                                </tr>
                                                                           </xsl:if>
                                                                           <xsl:if test="Data">
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="DatiGenerali/DatiSAL/RiferimentoFase">
                                                                           <tr><td width="70px">2.1.7.1</td><td width="170px">Nummer Baufortschritt<br /><i>Numero fase avanzamento</i></td>
                                                                                <td width="731px"><xsl:for-each select="DatiGenerali/DatiSAL/RiferimentoFase"><span><xsl:if test="(position( )) > 1">, </xsl:if><xsl:value-of select="." /></span></xsl:for-each></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </table>
                                                            </div>
                                                                           ...
                                                                           <xsl:for-each select="DatiGenerali/DatiTrasporto/DatiAnagraficiVettore">
                                                                                <xsl:if test="Anagrafica/Denominazione">
                                                                                     <tr><td width="70px">2.1.9.1.3.1</td><td width="170px">Benennung<br /><i>Denominazione</i></td>
                                                                                          <td width="731px"><span><xsl:value-of select="Anagrafica/Denominazione" /></span></td>
                                                                                     </tr>
                                                                                </xsl:if>
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="DatiGenerali/FatturaPrincipale/NumeroFatturaPrincipale">
                                                                           <tr><td  width="70px">2.1.10.1</td>
                                                                                ...
                                                                                <td width="731px"><span><xsl:value-of select="DatiGenerali/FatturaPrincipale/NumeroFatturaPrincipale" /></span></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                      <xsl:if test="DatiGenerali/FatturaPrincipale/DataFatturaPrincipale">
                                                                           <tr><td  width="70px">2.1.10.2</td>
                                                                                ...
                                                                                <td width="731px"><span><xsl:value-of select="DatiGenerali/FatturaPrincipale/DataFatturaPrincipale" /></span><xsl:call-template name="FormatDate"><xsl:with-param name="DateTime" select="DatiGenerali/FatturaPrincipale/DataFatturaPrincipale" /></xsl:call-template></td>
                                                                           </tr>
                                                                      </xsl:if>
                                                                 </table>
                                                            </div>
                                                  ...
                                                  <div id="dati-dettaglio-linee">
                                                            ...
                                                            <div id="righe">
                                                                ...
                                                                <table id="t2">
                                                                  <tr bgcolor="#998c99">
                                                                    ...
                                                                    <th width="518">Beschreibung<br />Descrizione cessione/prestazione</th>
                                                                    ...
                                                                    <td align="center"><span><xsl:value-of select="NumeroLinea" /></span></td>
                                                                      ...
                                                                      <xsl:if test="ScontoMaggiorazione/Tipo">
                                                                           <xsl:for-each select="ScontoMaggiorazione">
                                                                                <br /><span><xsl:value-of select="Percentuale" /> % <xsl:value-of select="Tipo" /></span>
                                                                                <xsl:variable name="TSCM"><xsl:value-of select="Tipo" /></xsl:variable>
                                                                                <xsl:choose>
                                                       ...
                                                       <xsl:if test="DatiBeniServizi/DatiRiepilogo">
                                                            <div id="riepilogo-aliquote-nature">
                                                                 ...
                                                                 <tr bgcolor="#998c99">
                                                                        <th width="50">MwSt<br />Aliq.</th>
                                                                        <th width="100">Art<br />Natura</th>
                                                                        <th width="140">Spesen<br />Spese</th>
                                                                        <th width="140">Rundung<br />Arroton.</th>
                                                                        <th width="140">Grundlage<br />Imponibile</th>
                                                                        <th width="140">Steuer<br />Imposta</th>
                                                                        <th width="92">Fälligkeit<br />Esigibilità</th>
                                                                        <th width="140">Ges.Bezug<br />Rif.Norma</th>
                                                                 </tr>
                                                            ...
                                                            <xsl:for-each select="DatiVeicoli">
                                                                 <xsl:if test="Data">
                                                                      <tr><td width="70px">2.3.1</td><td width="170px">Datum Ersteinschreibung des Fahrzeuges<br /><i> prima immatricolazione / iscrizione PR </i></td>
                                                                           <td width="731px"><span><xsl:value-of select="Data" /></span><xsl:call-template name="FormatDate"><xsl:with-param name="DateTime" select="Data" /></xsl:call-template></td>
                                                                      </tr>
                                                                 </xsl:if>
                                                            ...
                                                            <xsl:for-each select="DatiPagamento">
                                                                 ...
                                                                 <table id="t1">
                                                                      <tr><td width="70px">2.4.1</td><td width="170px">Zahlungsbedingungen<br /><i>Condizioni di pagamento</i></td>
                                                                           <td width="731px"><span><xsl:value-of select="CondizioniPagamento" /></span><xsl:variable name="CP"><xsl:value-of select="CondizioniPagamento" /></xsl:variable>
                                                                           <xsl:choose>
                                                                 ...
                                                                 <table id="t1">
                                                                      <xsl:if test="Beneficiario">
                                                                           <tr><td width="70px">2.4.2.1</td><td width="170px">Zahlungsempfänger<br /><i>Beneficiario pagamento</i></td>
                                                                                <td width="731px"><span><xsl:value-of select="Beneficiario" /></span></td>
                                                                           </tr>
                                                                           </xsl:if>
                                                                           <xsl:if test="ModalitaPagamento">
                                                                                <tr><td width="70px">2.4.2.2</td><td width="170px">Zahlungsmodalität<br /><i>Modalità di pagamento</i></td>
                                                                                     <td width="731px"><span><xsl:value-of select="ModalitaPagamento" /></span><xsl:variable name="MP"><xsl:value-of select="ModalitaPagamento" /></xsl:variable>
                                                                                     <xsl:choose>
                                                            ...
                                                            <table id="t1">
                                                                 <xsl:if test="NomeAttachment">
                                                                      <tr><td width="70px">2.5.1</td><td width="170px">Name der Anlage<br /><i>Nome dell'allegato</i></td>
                                                                           <td width="731px"><span><xsl:value-of select="NomeAttachment" /></span></td></tr>
                                                                 </xsl:if>
