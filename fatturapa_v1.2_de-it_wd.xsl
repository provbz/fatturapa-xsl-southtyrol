...
<xsl:stylesheet version="1.2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:a="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2">
     ...
     <xsl:variable name="VersionFT">
         <p>Stylesheet fatturapa_v1.2_de-it_wd.xsl v20170902 Ferdinand Tavernini - <a href="http://tinyurl.com/fatturapa-xsl-southtyrol">http://tinyurl.com/fatturapa-xsl-southtyrol</a></p>
     </xsl:variable>
