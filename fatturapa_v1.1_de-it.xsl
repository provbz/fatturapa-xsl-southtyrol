...
<!-- Versionsdatum: 2015-06-29 -->
<xsl:stylesheet 
    version="1.0" 
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:a="http://www.fatturapa.gov.it/sdi/fatturapa/v1.1">
    <xsl:output method="html" />
    <xsl:variable name="VersionFT" select="'Tabellenversion - Versione tabellare: 8.2 © 2015 Ferdinand TAVERNINI  GPLv3'" />
...
fattura-container { font-size: 10px; width: 80%; position: relative;}
                                ...
                                <div class="page">
                                                ...
                                                <table id="t1">
                                                    <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/RappresentanteFiscale/DatiAnagrafici">
                                                        ...
                                                        <xsl:if test="Anagrafica/Denominazione or Anagrafica/Titolo or Anagrafica/Nome or Anagrafica/Cognome">
                                                            <tr>
                                                                <td width="70px">1.2.2.[1|4|2|3]</td>
                                                                <td width="170px">Anschrift<br />
                                                                    <i>indirizzo</i>
                                                                </td>
                                                                <td width="364px">
                                                                    <span>
                                            ...
                                            <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/DatiAnagrafici">
                                                ...
                                                <table id="t1">
                                                    <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/DatiAnagrafici">
                                                        ...
                                                        <xsl:if test="Anagrafica/Denominazione or Anagrafica/Titolo or Anagrafica/Nome or Anagrafica/Cognome">
                                                            <tr>
                                                                <td width="70px">1.4.1.3.[1|4|2|3]</td>
                                                                <td width="170px">Benennung<br />
                                                                    <i>denominazione</i>
                                                                </td>
                                                                <td width="364px">
                                                                    <span>
                                            ...
                                            <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/Sede">
                                                ...
                                                <table id="t1">
                                                    <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/Sede">
                                                        ...
                                                        <xsl:if test="Indirizzo or NumeroCivico or CAP or Comune or Provincia or Nazione">
                                                            <tr>
                                                                <td width="70px">1.4.2.[1|2|3|4|5|6]</td>
                                                                <td width="170px">Anschrift<br />
                                                                    <i>indirizzo</i>
                                                                </td>
                                                                <td width="364px">
                                    ...
                                    <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/SoggettoEmittente">
                                        <div id="soggetto-emittente">
                                            ...
                                            <table id="t1">
                                                <tr>
                                                    <td width="70px">1.6</td>
                                                    <td width="170px">Austeller<br />
                                                    ...
                                                    <td width="364px">
                                                        ...
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:otherwise>
                                                                <fehler> (!!! falscher Kodex !!!)<i>(!!! codice non previsto !!!)</i></fehler>
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </td>
                                                </tr>
                            ...
                            <xsl:for-each select="a:FatturaElettronica/FatturaElettronicaBody">
                                ...
                                <div class="page">
                                                ...
                                                <div id="dati-generali-documento">
                                                    ...
                                                    <table id="t1">
                                                        <xsl:if test="DatiGenerali/DatiGeneraliDocumento/TipoDocumento">
                                                            <tr>
                                                                <td width="70px">2.1.1.[2|1]</td>
                                                                <td width="170px">Währung : Dokumententyp<br />
                                                                    <i>Valuta : Tipologia doc.</i>
                                                                </td>
                                                                <td width="364px">
                                                                    <span>
                                                                        <xsl:value-of select="$Valuta" />&#160;:&#160;<xsl:value-of select="DatiGenerali/DatiGeneraliDocumento/TipoDocumento" /> 
                                                                    </span>
                                                        ...
                                                        <xsl:if test="DatiGenerali/DatiGeneraliDocumento/Data">
                                                            <tr>
                                                                <td>2.1.1.[4|3]</td>
                                                                <td>Dok.-nummer und -datum<br />
                                                                    <i>Numero e data doc.</i>
                                                                </td>
                                                                <td>
                                                                    <span>
                                                                        <xsl:value-of select="DatiGenerali/DatiGeneraliDocumento/Numero" />&#160;-&#160;<xsl:value-of select="DatiGenerali/DatiGeneraliDocumento/Data" />
                                                                    </span>
                                                        ...
                                                        <xsl:if test="DatiGenerali/DatiGeneraliDocumento/Arrotondamento">
                                                            <tr>
                                                                <td>2.1.1.10</td>
                                                                <td>Rundung auf dem Gesamtbetrag<br />
                                                            ...
                                                            <xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/DatiRitenuta">
                                                                ...
                                                                <table id="t1">
                                                                    <xsl:if test="TipoRitenuta">
                                                                        <tr>
                                                                            <td width="70px">2.1.1.5.1</td>
                                                                            <td width="170px">Art des Einbehaltes<br />
                                                                    ...
                                                                    <xsl:if test="AliquotaRitenuta">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <span>
                                                                                    <xsl:value-of select="format-number(AliquotaRitenuta, '###')" /> %</span>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:if>
                                                                    <xsl:if test="CausalePagamento">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <xsl:if test="$CP!=''"> (Kodex nach Modell 770S)<i>(decodifica come da modello 770S)</i></xsl:if>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:if>
                                                                </table>
                                                            ...
                                                            <xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
                                                                ...
                                                                <table id="t1">
                                                                    <xsl:if test="BolloVirtuale">
                                                                        <tr>
                                                                            <td width="70px">2.1.1.6.1</td>
                                                                            <td width="170px">Virtueller Stempelwert<br />
                                                                                <i>Bollo virtuale</i>
                                                                            </td>
                                                                            <td width="364px">
                                                                                <span>
                                                            ...
                                                            <xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/DatiCassaPrevidenziale">
                                                                <table id="t1">
                                                                    <xsl:if test="TipoCassa">
                                                                        <tr>
                                                                            <td width="70px">2.1.1.7.1</td>
                                                                            <td width="170px">Fürsorgekasse<br />
                                                                    ...
                                                                    <xsl:if test="ImponibileCassa">
                                                                        <tr>
                                                                            <td>2.1.1.7.4</td>
                                                                            <td>Grundlage Fürsorgebeitrag<br />
                                                                    ...
                                                                    <xsl:if test="AlCassa">
                                                                        <tr>
                                                                            <td>2.1.1.7.2</td>
                                                                            <td>Fürsorgebeitragssatz (%)<br />
                                                                                <i>Aliquota contri. cassa (%)</i>
                                                                            </td>
                                                                            <td>
                                                                                <span>
                                                                                    <xsl:value-of select="format-number(AlCassa, '###')" /> %</span>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:if>
                                                                    ...
                                                                    <xsl:if test="AliquotaIVA">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <span>
                                                                                    <xsl:value-of select="format-number(AliquotaIVA, '###')" /> %</span>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:if>
                                                                    <xsl:if test="Ritenuta">
                                                                        <tr>
                                                                            <td>2.1.1.7.6</td>
                                                                            <td>Fürsorgebeitrag im Abzug<br />
                                                                    ...
                                                                    <xsl:if test="Natura">
                                                                        <tr>
                                                                            <td>2.1.1.7.7</td>
                                                                            <td>Art der Beitragsfreistellung<br />
                                                                    ...
                                                                    <xsl:if test="RiferimentoAmministrazione">
                                                                        <tr>
                                                                            <td>2.1.1.7.8</td>
                                                                            <td>Hinweis Verwaltung / Buchhaltung<br />
                                                        ...
                                                        <div id="dati-sconto-maggiorazione">
                                                            <xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/ScontoMaggiorazione">
                                                                <table id="t1">
                                                                    <xsl:if test="Tipo">
                                                                        <tr>
                                                                            <td width="70px">2.1.1.8.1</td>
                                                                            <td width="170px">Typologie<br />
                                                                                <i>Tipologia</i>
                                                                            </td>
                                                                            <td width="364px">
                                                                                <span>
                                                    ...
                                                    <table id="t1">
                                                        <xsl:for-each select="DatiGenerali/DatiOrdineAcquisto">
                                                            <xsl:if test="RiferimentoNumeroLinea">
                                                                <tr>
                                                                    <td width="70px">2.1.2.1</td>
                                                                    <td width="170px">Zugehörige Zeilennummer der Rechnung<br />
                                                            ...
                                                            <xsl:if test="IdDocumento">
                                                                <tr>
                                                                    <td width="70px">2.1.2.2</td>
                                                                    <td width="170px">Bestellkennung<br />
                                                            ...
                                                            <xsl:if test="NumItem">
                                                                <tr>
                                                                    <td>2.1.2.4</td>
                                                                    <td>Zeilennummer der Bestellung<br />
                                                            ...
                                                            <xsl:if test="CodiceCommessaConvenzione">
                                                                <tr>
                                                                    <td>2.1.2.5</td>
                                                                    <td>Verkaufs-/Konventionskodex<br />
                                                            ...
                                                            <xsl:if test="CodiceCUP">
                                                                <tr>
                                                                    <td>2.1.2.6</td>
                                                                    <td>Staatlicher Projektkodex<br />
                                                ...
                                                <div id="dati-contratto">
                                                    ...
                                                    <table id="t1">
                                                        <xsl:for-each select="DatiGenerali/DatiContratto">
                                                            ...
                                                            <xsl:if test="IdDocumento">
                                                                <tr>
                                                                    <td width="70px">2.1.3.2</td>
                                                                    <td width="170px">Vertragskenndaten<br />
                                                                        <i>Ident. contratto</i>
                                                                    </td>
                                                                    <td width="364px">
                                                                        <span>
                                                    ...
                                                    <table id="t1">
                                                        <xsl:for-each select="DatiGenerali/DatiRicezione">
                                                            ...
                                                            <xsl:if test="IdDocumento">
                                                                <tr>
                                                                    <td>2.1.5.2</td>
                                                                    <td>Kennzeichen des Empfangs<br />
                                                                        <i>Ident. ricezione</i>
                                                                    </td>
                                                                    <td>
                                                                        <span>
                                                            ...
                                                            <xsl:if test="NumItem">
                                                                <tr>
                                                                    <td>2.1.5.4</td>
                                                                    <td>Zeilennummer des Empfangs<br />
                                                    ...
                                                    <table id="t1">
                                                        <xsl:for-each select="DatiGenerali/DatiFattureCollegate">
                                                            ...
                                                            <xsl:if test="IdDocumento">
                                                                <tr>
                                                                    <td>2.1.6.2</td>
                                                                    <td>Kennzeichen der dazugehörenden Rechnung<br />
                                                            ...
                                                            <xsl:if test="Data">
                                                                <tr>
                                                                    <td>2.1.6.3</td>
                                                                    <td>Datum der dazugehörenden Rechnung<br />
                                                            ...
                                                            <xsl:if test="NumItem">
                                                                <tr>
                                                                    <td>2.1.6.4</td>
                                                                    <td>Zeilennummer bei der dazugehörenden Rechnung<br />
                                                ...
                                                <div id="dati-sal">
                                                    ...
                                                    <table id="t1">
                                                        <xsl:if test="DatiGenerali/DatiSAL/RiferimentoFase">
                                                            <tr>
                                                                <td width="70px">2.1.7.1</td>
                                                                <td width="170px">Nummer Baufortschritt<br />
                                                    ...
                                                    <table id="t1">
                                                        <xsl:for-each select="DatiGenerali/DatiDDT">
                                                            <xsl:if test="NumeroDDT or DataDDT or RiferimentoNumeroLinea">
                                                                <tr>
                                                                    <td width="70px">2.1.8.[1|2|3]</td>
                                                                    <td width="170px">Nummer, Datum WBS<br />
                                                                        <i>Numero data DDT</i>
                                                                    </td>
                                                                    <td width="364px">
                                                                        ...
                                                                        <xsl:if test="DataDDT"> vom/<i>del</i>&#160;
                                                                            <span>
                                                                        ...
                                                                        <xsl:if test="RiferimentoNumeroLinea">
                                                                            <br />Betrifft Zeile/<i>Rif.linea</i>&#160;
                                                                            <xsl:for-each select="RiferimentoNumeroLinea">
                                                                                <span>
                                                                                    <xsl:if test="(position( )) > 1">, </xsl:if>
                                                                                    <xsl:value-of select="." />
                                                    ...
                                                    <table id="t1">
                                                        <xsl:if test="DatiGenerali/DatiTrasporto/DatiAnagraficiVettore">
                                                            <xsl:for-each select="DatiGenerali/DatiTrasporto/DatiAnagraficiVettore">
                                                                ...
                                                                <xsl:if test="Anagrafica/Nome">
                                                                    <tr>
                                                                        <td width="90px">2.1.9.1.3.2</td>
                                                                        <td width="170px">Name<br />
                                                                            <i>Nome</i>
                                                                        </td>
                                                                        <td width="364px">
                                                                            <span>
                                                        ...
                                                        <xsl:if
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <h4>Weitere Daten - <i>Altri dati</i></h4>
                                                                </td>
                                                            </tr>
                                                            <xsl:for-each select="DatiGenerali/DatiTrasporto">
                                                                ...
                                                                <xsl:if test="Descrizione">
                                                                    <tr>
                                                                        <td>2.1.9.5</td>
                                                                        <td>Beschreibung der transportierten Güter<br />
                                                                ...
                                                                <xsl:if test="DataOraRitiro">
                                                                    <tr>
                                                                        <td>2.1.9.9</td>
                                                                        <td>Datum und Zeit der Abgabe<br />
                                                                ...
                                                                <xsl:if test="TipoResa">
                                                                    <tr>
                                                                        <td>2.1.9.11</td>
                                                                        <td>Typologie der Abgabe<br />
                                                                            <i>Tipologia di resa</i>
                                                                        </td>
                                                                        <td>
                                                                            <span>
                                                                                <xsl:value-of select="TipoResa" />
                                                                            </span> (Kodifizierung nach ICC-Standard)<br />
                                                                ...
                                                                <xsl:if test="IndirizzoResa/NumeroCivico">
                                                                    <tr>
                                                                        <td>2.1.9.12.2</td>
                                                                        <td>Hausnummer Abgabeadresse<br />
                                            ...
                                            <xsl:if test="DatiGenerali/FatturaPrincipale/NumeroFatturaPrincipale">
                                                <div id="fattura-principale">
                                                    ...
                                                    <table id="t1">
                                                        <xsl:if test="DatiGenerali/FatturaPrincipale/NumeroFatturaPrincipale">
                                                            <tr>
                                                                <td  width="70px">2.1.10.1</td>
                                                                <td width="170px">Nummer der Hauptrechnung<br />
                                                        ...
                                                        <xsl:if test="DatiGenerali/FatturaPrincipale/DataFatturaPrincipale">
                                                            <tr>
                                                                <td  width="70px">2.1.10.2</td>
                                                                <td width="170px">Datum Hauptrechnung<br />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <xsl:if test="ScontoMaggiorazione/Tipo">
                                                                        <br />
                                                                        <span>
                                                                            <xsl:value-of select="ScontoMaggiorazione/Tipo" />
                                                                        </span>
                                                                        ...
                                                                        <span>
                                                                            <xsl:value-of select="ScontoMaggiorazione/Percentuale" />%</span>
                                                                    </xsl:if>
                                                                </td>
                                                                <td align="right">
                                                                ...
                                                                <td align="right">
                                                                    <xsl:if test="ScontoMaggiorazione/Importo">
                                                                        <span>
                                                                            <xsl:value-of select="format-number(ScontoMaggiorazione/Importo, '###.##0,00', 'euro')" />
                                                                        </span>
                                                                    </xsl:if>
                                                                </td>
                                                                <td align="right">
                                    ...
                                    <xsl:if test="DatiVeicoli">
                                        <div id="dati-veicoli">
                                            <h3>Daten zum Transportfahrzeug - <i>Dati Veicoli ex art. 38 dl 331/1993</i></h3>
                                            <table id="t1">
                                                <xsl:for-each select="DatiVeicoli">
                                                    <xsl:if test="Data">
                                                        <tr>
                                                            <td width="70px">2.3.1</td>
                                                            <td width="170px">Datum Ersteinschreibung des Fahrzeuges<br />
                                            ...
                                            <table id="t1">
                                                <xsl:for-each select="DatiPagamento">
                                                    <xsl:if test="CondizioniPagamento">
                                                        <tr>
                                                            <td width="70px">2.4.1</td>
                                                            <td width="170px">Zahlungsbedingungen<br />
                                                    ...
                                                    <xsl:if test="DettaglioPagamento">
                                                        ...
                                                        <xsl:for-each select="DettaglioPagamento">
                                                            ...
                                                            <xsl:if test="CognomeQuietanzante">
                                                                <tr>
                                                                    <td>2.4.2.9</td>
                                                                    <td>Nachname des Quittierenden<br />
                                                            ...
                                                            <xsl:if test="ScontoPagamentoAnticipato">
                                                                <tr>
                                                                    <td>2.4.2.17</td>
                                                                    <td>Skonto für Zahlung vor Zahlungsziel<br />
                                                            ...
                                                            <xsl:if test="DataLimitePagamentoAnticipato">
                                                                <tr>
                                                                    <td>2.4.2.18</td>
                                                                    <td>letzter Termin für Zahlung vor Zahlungsziel<br />
                                                            ...
                                                            <xsl:if test="PenalitaPagamentiRitardati">
                                                                <tr>
                                                                    <td>2.4.2.19</td>
                                                                    <td>Pönale für verspätete Zahlung<br />
                                                            ...
                                                            <xsl:if test="DataDecorrenzaPenale">
                                                                <tr>
                                                                    <td>2.4.2.20</td>
                                                                    <td>Beginndatum für Anwendung der Pönale<br />
                                    ...
                                    <xsl:if test="Allegati">
                                        <div id="allegati">
                                            <h3>Daten zu den Anlagen - <i>Dati relativi agli allegati</i></h3>
                                            <xsl:for-each select="Allegati">
                                                <table id="t1">
                                                    <xsl:if test="NomeAttachment">
                                                        <tr>
                                                            <td width="70px">2.5.1</td>
                                                            <td width="170px">Name der Anlage<br />
