...
<xsl:stylesheet 
     ...
     <xsl:variable name="VersionFT">
         <p>Stylesheet fatturapa_v1.1_de-it.xsl v20150818 ft - <a href="http://tinyurl.com/fatturapa-xsl-southtyrol">http://tinyurl.com/fatturapa-xsl-southtyrol</a></p>
     </xsl:variable>
